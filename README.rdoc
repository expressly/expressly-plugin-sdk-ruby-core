...
You can find a Rails reference implementation {here}[https://github.com/expressly/expressly-plugin-rails-reference-implementation/blob/master/README.md]
to help you get started.

== More Info

Further resources can be found on the Expressly {the developer portal}[http://developer.buyexpressly.com].
